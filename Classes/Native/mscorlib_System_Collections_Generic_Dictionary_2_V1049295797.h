...
struct  ValueCollection_t1049295797  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_dictionary_0() { return static_cast<int32_t>(offsetof(ValueCollection_t1049295797, ___dictionary_0)); }
