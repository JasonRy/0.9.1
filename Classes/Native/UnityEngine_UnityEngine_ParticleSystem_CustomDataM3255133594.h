...
struct  CustomDataModule_t3255133594 
{
public:
...
public:
	inline static int32_t get_offset_of_m_ParticleSystem_0() { return static_cast<int32_t>(offsetof(CustomDataModule_t3255133594, ___m_ParticleSystem_0)); }
...
struct CustomDataModule_t3255133594_marshaled_pinvoke
{
	ParticleSystem_t3394631041 * ___m_ParticleSystem_0;
};
// Native definition for COM marshalling of UnityEngine.ParticleSystem/CustomDataModule
struct CustomDataModule_t3255133594_marshaled_com
{
	ParticleSystem_t3394631041 * ___m_ParticleSystem_0;
};
