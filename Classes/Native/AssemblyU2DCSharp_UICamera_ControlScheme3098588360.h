...
struct  ControlScheme_t3098588360 
{
public:
...
public:
	inline static int32_t get_offset_of_value___1() { return static_cast<int32_t>(offsetof(ControlScheme_t3098588360, ___value___1)); }
