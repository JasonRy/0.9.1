...
struct  KeyCollection_t226755751  : public Il2CppObject
{
public:
...
public:
	inline static int32_t get_offset_of_dictionary_0() { return static_cast<int32_t>(offsetof(KeyCollection_t226755751, ___dictionary_0)); }
